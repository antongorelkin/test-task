<template>
  <div id="item">
    <svg class="svg" width="145" height="145" viewBox="0 0 145 145" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M145 72.5C145 112.541 112.541 145 72.5 145C32.4594 145 0 112.541 0 72.5C0 32.4594 32.4594 0 72.5 0C112.541 0 145 32.4594 145 72.5ZM11.8357 72.5C11.8357 106.004 38.9961 133.164 72.5 133.164C106.004 133.164 133.164 106.004 133.164 72.5C133.164 38.9961 106.004 11.8357 72.5 11.8357C38.9961 11.8357 11.8357 38.9961 11.8357 72.5Z"
        :fill="getFillColor(state)" />
    </svg>
    <span>
      <svg width="86" height="86" viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink">
        <mask id="mask0_1_139" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="86" height="86">
