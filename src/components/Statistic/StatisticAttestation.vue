  ...
  <div id="item">
    <div class="statistic-wrap">
      <div class="circle circle--static">
        <StatisticDiagram v-if="timer.minutes < 1" class-circle-front="orange"
          :data-dasharray="[timePassed, timer.total]" radius="51%" isTimer />
        <StatisticDiagram v-else class-circle-front="green" :data-dasharray="[timePassed, timer.total]" radius="51%"
          isTimer />
        <span>
          {{ time }}
        </span>
